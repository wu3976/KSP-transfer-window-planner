...
public class PlannerFrame extends JFrame {
    ...
    class calListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            for (int i = 0; i < PlannerFrame.this.names.size(); i++) {
                if (s1.equals(PlannerFrame.this.names.get(i))) {
                    t1 = PlannerFrame.this.orbPer.get(i);
                    t1getted = true;
                    break;
                }
            }
            for (int i = 0; i < PlannerFrame.this.names.size(); i++) {
                if (s2.equals(PlannerFrame.this.names.get(i))) {
                    t2 = PlannerFrame.this.orbPer.get(i);
                    t2getted = true;
                    break;
                }
            }
